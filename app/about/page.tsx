    ...
    <div className="mt-12 space-y-12 font-mono max-w-[700px] mx-auto">
      ...
      <section className="space-y-4">
        ...
        <p className="leading-relaxed">
          NEXT YZY is a minimalist ecommerce template inspired by the design
      ...
      <section className="space-y-4">
        ...
        <p className="leading-relaxed">
          Built using Next.js App Router, TypeScript, and Tailwind CSS, NEXT YZY
      ...
      <section className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          Yeezy team and designers. Product images were generated by lee robinson
